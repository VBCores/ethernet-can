...
- Keep host JSON parsing in `extra/start_ethernet_can.py`; keep the host binary driven by CLI args.
- When changing config semantics, update `README.md`, `extra/configs/example.json`, and relevant app notes together.
